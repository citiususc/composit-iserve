...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        final OperationManager opManager = new iServeOperationManagerImpl(serviceManager);
        ...
        CompositionProblem<URI, LogicConceptMatchType> problem = new CompositionProblem<URI, LogicConceptMatchType>() {
            ...
            @Override
            public DiscoveryIO<URI> getDiscoveryIO() {
                return new iServeDiscoveryIO(opManager, serviceManager, matchGraph);
            }
        };
